    ...
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            <div class=" col-md-8">
            <form action="{{url('/index/galery')}}" method="post" enctype="multipart/form-data">
              @csrf
                <label>Judul :</label>
                <input type="text" name="judul" class="form-control" placeholder="Enter judul maksimal 100 karakter " required maxlength="100">
                <label>Deskripsi</label>
                <textarea name="deskripsi" placeholder="Enter Deskripsi 150 karakter" maxlength="150"  class="form-control" ></textarea> 
                <label>Isi </label>
            ...
            <table class="table table-striped table-bordered datatable" >
              ...
              @foreach($data as $dt)
               <tr>
                ...
                <td>{{$dt->judul}}</td>
                <td>
                  <img src="{{asset('/upload/galery/'.$dt->file)}}" style="width: 200px; height: 100px;">
                </td>
                <td>
                  {{date('d F Y', strtotime($dt->created_at))}}
                </td>
                <td>
                  <form action="{{url('/index/'.$dt->id.'/galery/delete')}}" method="post">
                    @csrf @method('delete')
                    <a href="{{url('/index/'.$dt->id.'/galery/edit')}}" class="btn btn-info">Edit</a>
