  ...
  <div class="row">
    <div class="col-md-12">
       <div class="panel panel-info">
            ...
            <div class=" col-md-8">
            <form action="{{url('/index/'.$data->id.'/typerumah/edit')}}" method="post" enctype="multipart/form-data">
              @csrf @method('put')
                <label>Judul :</label>
                ...
                <textarea name="deskripsi" id="ckeditor" class="ckeditor" >{{$data->deskripsi}}</textarea>
                <label>Gambar</label>
           ...
           <div class="col-md-4">
            <div id="preview">
              ...
              <img v-else src="{{asset('/upload/rumah/'.$data->file)}}" style="width: 100%;max-height: 400px;" />
            </div>
          </div>
            </div>
        </div>
