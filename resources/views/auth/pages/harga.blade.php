    ...
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            <div class=" col-md-12">
            <form action="{{url('/index/harga')}}" method="post" enctype="multipart/form-data">
              @csrf
                <label>Judul :</label>
                <input type="text" name="judul" class="form-control" placeholder="Enter judul maksimal 100 karakter "  required maxlength="100">
                <label>Harga :</label>
                <input type="text" name="harga" class="form-control" placeholder="Enter Harga" required maxlength="100">
            ...
            <table class="table table-striped table-bordered datatable" >
              ...
              @foreach($data as $dt)
               <tr>
                ...
                <td>
                  <form action="{{url('/index/'.$dt->id.'/harga/delete')}}" method="post">
                    @csrf @method('delete')
                    <a href="{{url('/index/'.$dt->id.'/harga/edit')}}" class="btn btn-info">Edit</a>
